...
namespace REP_II_Max
{
    public class Bridge : AssepontoRep.Bridge
    {
        ...
        public override string getRepFabricante() { return "Kurumim - REP II Max"; }
        ...
        private string Args()
        {
            ...
            return " /net /nr" + TerminalDados.Serial + " /s" + TerminalDados.SupervisorCodigo + " /ip" + TerminalDados.IP;
        }
        ...
        public bool processStart(string comando, string parametros)
        {
            ...
            info.Arguments = comando + parametros;
