...
namespace Trilobit
{
    public class Rede
    {
        ...
        public void HorarioDeVerao(string IP, int Porta, int Senha, string Inicio, string Fim)
        {
                            
              if (Rep.EnviarConfiguracao(IP, Porta, Senha, REP.eParamSetConfig.InicioHorarioVerao, Inicio))
                   this.AddLog("HORARIO DE INICIO ATUALIZADO COM SUCESSO");
              else
                   LogErro();

              if (Rep.EnviarConfiguracao(IP, Porta, Senha, REP.eParamSetConfig.FimHorarioVerao, Fim))
                   this.AddLog("HORARIO FINAL ATUALIZADO COM SUCESSO");
              else
                    LogErro();           
        }
    }
