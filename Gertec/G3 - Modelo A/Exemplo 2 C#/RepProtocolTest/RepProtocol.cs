...
namespace RepProtocolTestSuite
{
    ...
    class RepProtocol
    {
        ...
        public void RemoveEmployee(string PIS)
        {
            Dictionary<string, string> postData = new Dictionary<string, string>();
            postData.Add("PIS", PIS);
            string resp = server.DoPostRequest(baseAddress + "MT/Employee/RemoveEmployee", postData, this, new ErrorCodes[] { ErrorCodes.MT_RES_ERROR_NOT_ENROLLED_EMPLOYEE });
        }

        public void SetEmployee(Empregado empregado)
        {
            Dictionary<string, string> postData = new Dictionary<string, string>();
            ...
            string resp = server.DoPostRequest(baseAddress + "MT/Employee/SetEmployee", postData, this, new ErrorCodes[] { ErrorCodes.MT_RES_ERROR_ENROLLED_ID, ErrorCodes.MT_RES_ERROR_ENROLLED_KEYBOARD, ErrorCodes.MT_RES_ERROR_ENROLLED_PIS });
        }

        public void EditEmployee(Empregado empregado)
        {
            Dictionary<string, string> postData = new Dictionary<string, string>();
            postData.Add("PIS", empregado.PIS);
            postData.Add("ID", empregado.ID);
            ...
            postData.Add("CNTLS", empregado.CNTLS);
            postData.Add("KBD", empregado.KBD);
            string resp = server.DoPostRequest(baseAddress + "MT/Employee/EditEmployee", postData, this);
        }
        ...
        public void SetTime(DateTime time)
        {
            ...
            string resp = server.DoPostRequest(baseAddress + "MRP/RTC/SetTime", postData, this);
        }
        ...
        public void EditEmployer(Empregador empregador)
        {
            Dictionary<string, string> postData = new Dictionary<string, string>();
            postData.Add("CNPJ", empregador.CNPJ);
            postData.Add("CEI", empregador.CEI);
            ...
            postData.Add("NOME", empregador.Nome);
            postData.Add("END", empregador.Endereco);
            string resp = server.DoPostRequest(baseAddress + "MT/Employer/EditEmployer", postData, this);
        }
