...
{
    public class clRetornaErro
    {
        public static string retornoREP(int valor)
        {
            string retorno = "";
            ...
            switch (valor)
            {
                ...
                case 3022: retorno = " Cartão de proximidade já cadastrado."; break;
                ...
                case 3105: retorno = " Tamanho do Código de Proximidade inválido."; break;
                ...
                case 3202: retorno = " Registro (Contactless) já cadastrado."; break;
                ...
                case 4100: retorno = " Não existe biometria cadastrada"; break;
