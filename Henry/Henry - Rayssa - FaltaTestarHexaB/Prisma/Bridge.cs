...
namespace Prisma
{
    class Bridge : AssepontoRep.Bridge
    {
        ...
        public override string getRepFabricante() { return "Henry - SuperFacil/Prisma"; }
        public override string getArquivoUsb() { return "SuperFacil-Prisma"; }
        ...
        public void Send(string Packet, out string Answer)
        {
            ...
            bytes = ConvertClass.ConvertStringToBytes(Packet);
        ...
        private bool ProcessAnswer(string Answer, string data = "")
        {
            ...
            {
                NMarcacoes = Convert.ToInt32(Answer.Substring(11));
                            ...
                            if (Answer.StartsWith("01+RR+0+") || Answer.StartsWith("01+RR+000+"))
            {
                ...
                NMarcacoes = Convert.ToInt32(temp.Substring(0, temp.IndexOf(']')));
            ...
            {
                int CodigoErro = Convert.ToInt32(Answer.Substring(5));
