        ...
        public override bool Connect(int Terminal)
        {
            ...
            do
            {
                try
                {
                    ...
                    IPHostEntry ipHostInfo = Dns.Resolve(TerminalDados.IP);
                    IPAddress ipAddress = ipHostInfo.AddressList[0];
                    IPEndPoint remoteEP = new IPEndPoint(ipAddress, TerminalDados.Porta);
                    string command = "";
                    string preCommand = "";
                    string strModulo = "";
                    string strExpodente = "";
                ...
                {
                    log.AddLog("ERRO AO CONECTAR COM O RELÓGIO");
                    retorno = false;
                }
            }
