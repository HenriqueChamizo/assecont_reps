...
namespace ZPM
{
    public class Bridge : AssepontoRep.Bridge
    {
        ...
        public override string getRepFabricante() { return "ZPM Eco500"; }
        public override string getArquivoUsb() { return "ZPM  Eco500"; }
        ...
        private bool getPeriodo(out DateTime DataInicial, out DateTime DataFinal)
        {
            ...
            DataInicial = Convert.ToDateTime(Registro.getValue(getRepFabricante(), "Data inicial importacao", DateTime.Today.ToShortDateString()));
            DataFinal = Convert.ToDateTime(Registro.getValue(getRepFabricante(), "Data Final importacao", DateTime.Today.ToShortDateString())); ;
            ...
            if (frmImportacaoMarcacoes.ShowDialog() == DialogResult.OK)
            {
                ...
                Registro.setValue(getRepFabricante(), "Data inicial importacao", DataInicial.ToShortDateString());
                Registro.setValue(getRepFabricante(), "Data Final importacao", DataFinal.ToShortDateString());
