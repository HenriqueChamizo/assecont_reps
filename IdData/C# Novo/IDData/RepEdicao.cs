        ...
        private void btOk_Click(object sender, EventArgs e)
        {
            ...
            if (Terminal > 0)
                Comm.CommandText = "UPDATE Terminais SET TRM_DESCRICAO = @DESCRICAO, TRM_IP = @IP, " +
                                   ...
                                   "TRM_RAZAOSOCIAL = @RAZAOSOCIAL, TRM_CNPJ = @CNPJ, TRM_CPF = @CPF, TRM_ENDERECO = @ENDERECO, TRM_NUMERO = @NUMERO " +
                                   "WHERE TRM_IND = " + Terminal.ToString();
            else
                Comm.CommandText = "INSERT INTO Terminais (TRM_DESCRICAO, TRM_IP, TRM_PORTA, TRM_GRUPO, " +
                                   "TRM_FABRICANTE, TRM_RAZAOSOCIAL, TRM_CNPJ, TRM_CPF, TRM_ENDERECO, TRM_NUMERO) VALUES (@DESCRICAO, " +
                                   "@IP, @PORTA, @GRUPO, @FABRICANTE, @RAZAOSOCIAL, @CNPJ, @CPF, @ENDERECO, @NUMERO)";
