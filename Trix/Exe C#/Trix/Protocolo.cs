...
namespace Trix
{
    public class Comando
    {
        ...
        public Comando(string pTipoComando, string pModo, byte[] pMensagem)
        {
            tipoComando = pTipoComando;
            modo = pModo;
            mensagem = rStrings.ConvertByteToString(pMensagem);
            tamanhoMensagem = mensagem.Length.ToString();
            for (int i = tamanhoMensagem.Length; i < 3; i++)
                tamanhoMensagem = "0" + tamanhoMensagem;
            CalculaCRC();
        ...
        public string InfoDataHora()
        {
            string dia = mensagem.Substring(17, 2);
            string mes = mensagem.Substring(19, 2);
            string ano = mensagem.Substring(21, 4);
            string hora = mensagem.Substring(25, 2);
            string minuto = mensagem.Substring(27, 2);

            string data = dia + "/" + mes + "/" + ano;
            string horario = hora + ":" + minuto;

            string res = data + " " + horario;
        ...
        public string InfoFuncionario()
        {
            ...
            string pis = mensagem.Substring(29, 12);
