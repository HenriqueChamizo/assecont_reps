...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        public zkemkeeperbz900.CBZ900Class axCZKEM1 = new zkemkeeperbz900.CBZ900Class();
        ...
        * *******************************************************************************************************************************************/
        ...
        private void btnDelUserDataEx_Click(object sender, EventArgs e)
        {
            ...
            Cursor = Cursors.WaitCursor;
            if (axCZKEM1.SSR_DeleteEnrollDataExt_BZ400(iMachineNumber,sUserID,iBackupNumber))
            {
