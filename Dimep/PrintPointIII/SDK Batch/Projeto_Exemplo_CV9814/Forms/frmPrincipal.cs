...
namespace ExemploREP.Forms
{
    ...
    public enum ETipoComando
    {
        ...
        InsereFeriadosLista,
        InserePermissaoLista,
        RemovePermissaoLista,
        ExclusaoTotalPermissoes
    }
    ...
    public partial class frmPrincipal : Form
    {
        ...
        private dsSDKREP.dtFeriadosDataTable _dtFeriados;
        private dsSDKREP.dtFaixasPermissaoDataTable _dtFaixasPermissao;
        ...
        private void BindingDataTables()
        {
            ...
            this._dtFeriados = this._dsREP.dtFeriados;
            this._dtFaixasPermissao = this._dsREP.dtFaixasPermissao;
        ...
        private void BindingDataGrids()
        {
            ...
            this.dtgFeriados.DataSource = this._dtFeriados;
            this.dtgPermissoes.DataSource = this._dtFaixasPermissao;
        }
        ...
        private String DescricaoComando(ETipoComando comando)
        {
            ...
            { 
                ...
                case ETipoComando.InsereFeriadosLista:
                    return "Insere lista de feriados";
                case ETipoComando.InserePermissaoLista:
                    return "Insere permissão na lista";
                case ETipoComando.RemovePermissaoLista:
                    return "Remove permissão da lista";
                case ETipoComando.ExclusaoTotalPermissoes:
                    return "Exclusão total de permissões";
            }
        ...
        private void InstanciaWatchComm()
        {
            ...
            this._watchComm = new org.cesar.dmplight.watchComm.impl.WatchComm(org.cesar.dmplight.watchComm.api.WatchProtocolType.TimePointCV9814,
                                                                              tcpComm,
                                                                              1,
                                                                              key,
        ...
        private void btnIncluirFuncionarios_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                foreach (DataRow dr in this._dtFuncionarios)
                {
                    try
                    {
                        if (!DateTime.TryParse(dr["InicioAfastamento"].ToString(), out inicioAfastamento))
                        {
                            inicioAfastamento = DateTime.MinValue;
                        }

                        if (!DateTime.TryParse(dr["FimAfastamento"].ToString(), out fimAfastamento))
                        {
                            fimAfastamento = DateTime.MinValue;
                        }

                        this._watchComm.AddTimePointCV9814Employee(dr["PIS"].ToString(), dr["Nome"].ToString(), dr["Senha"].ToString(),
                                inicioAfastamento, fimAfastamento,
                                Int16.Parse(dr["PermissaoSemana"].ToString()), Int16.Parse(dr["PermissaoSabado"].ToString()),
                                Int16.Parse(dr["PermissaoDomingo"].ToString()), Int16.Parse(dr["PermissaoFeriado"].ToString()),
                                Boolean.Parse(dr["VerificaFaixasPessoa"].ToString().ToUpper().Equals("TRUE") ? "True" : "False"),
                                new TimeSlot[] { new TimeSlot() { InitialTime = DateTime.Parse(dr["InicioFaixaDomingo"].ToString().Equals("") ? "00:00" : dr["InicioFaixaDomingo"].ToString()), 
                                                              FinalTime = DateTime.Parse(dr["FimFaixaDomingo"].ToString().Equals("") ? "00:00" : dr["FimFaixaDomingo"].ToString()) } },
                                new TimeSlot[] { new TimeSlot() { InitialTime = DateTime.Parse(dr["InicioFaixaSegunda"].ToString().Equals("") ? "00:00" : dr["InicioFaixaSegunda"].ToString()), 
                                                              FinalTime = DateTime.Parse(dr["FimFaixaSegunda"].ToString().Equals("") ? "00:00" : dr["FimFaixaSegunda"].ToString()) } },
                                new TimeSlot[] { new TimeSlot() { InitialTime = DateTime.Parse(dr["InicioFaixaTerca"].ToString().Equals("") ? "00:00" : dr["InicioFaixaTerca"].ToString()), 
                                                              FinalTime = DateTime.Parse(dr["FimFaixaTerca"].ToString().Equals("") ? "00:00" : dr["FimFaixaTerca"].ToString()) } },
                                new TimeSlot[] { new TimeSlot() { InitialTime = DateTime.Parse(dr["InicioFaixaQuarta"].ToString().Equals("") ? "00:00" : dr["InicioFaixaQuarta"].ToString()), 
                                                              FinalTime = DateTime.Parse(dr["FimFaixaQuarta"].ToString().Equals("") ? "00:00" : dr["FimFaixaQuarta"].ToString()) } },
                                new TimeSlot[] { new TimeSlot() { InitialTime = DateTime.Parse(dr["InicioFaixaQuinta"].ToString().Equals("") ? "00:00" : dr["InicioFaixaQuinta"].ToString()), 
                                                              FinalTime = DateTime.Parse(dr["FimFaixaQuinta"].ToString().Equals("") ? "00:00" : dr["FimFaixaQuinta"].ToString()) } },
                                new TimeSlot[] { new TimeSlot() { InitialTime = DateTime.Parse(dr["InicioFaixaSexta"].ToString().Equals("") ? "00:00" : dr["InicioFaixaSexta"].ToString()), 
                                                              FinalTime = DateTime.Parse(dr["FimFaixaSexta"].ToString().Equals("") ? "00:00" : dr["FimFaixaSexta"].ToString()) } },
                                new TimeSlot[] { new TimeSlot() { InitialTime = DateTime.Parse(dr["InicioFaixaSabado"].ToString().Equals("") ? "00:00" : dr["InicioFaixaSabado"].ToString()), 
                                                              FinalTime = DateTime.Parse(dr["FimFaixaSabado"].ToString().Equals("") ? "00:00" : dr["FimFaixaSabado"].ToString()) } });
                    }
                    catch (Exception ex)
                    {
                        ErroDuranteRecepcaoDoComando(ex);
                ...
                try
                {
                    ...
                    this._watchComm.IncludeTimePointCV9814EmployeesList();                    
        ...
        private void btnObterRegistrosMRP_Click(object sender, EventArgs e)
        {
            ...
            TimePointCV9814EventRecords[] eventRecords;
            ...
            try
            {
                ...
                eventRecords = this._watchComm.InquiryTimePointCV9814EventRecords();
                ...
                else
                {
                    ...
                    {
                        foreach (TimePointCV9814EventRecords eventRecord in eventRecords)
                        {
                            DataRow dr = this._dtMarcacoes.NewRow();
                            
                            dr["NSR"] = eventRecord.NSR;
                            dr["DataHoraGravacao"] = eventRecord.DateTimeMarkingPoint;
                            dr["PIS"] = eventRecord.Pis;

                            switch (eventRecord.EventRecordType)
                            {
                                case TipoPointCV9814EventRecordType.AccessGranted:
                                    dr["Evento"] = "Acesso permitido";
                                    break;
                                case TipoPointCV9814EventRecordType.AccessDeniedByRemovalPeriod:
                                    dr["Evento"] = "Acesso negado por período de afastamento";
                                    break;
                                case TipoPointCV9814EventRecordType.AccessDeniedByTimeSlot:
                                    dr["Evento"] = "Acesso negado por faixa horária";
                                    break;
                                case TipoPointCV9814EventRecordType.AccessDeniedByPermissionTimeSlot:
                                    dr["Evento"] = "Acesso negado por faixa horária de permissão";
                                    break;
                                case TipoPointCV9814EventRecordType.AccessDeniedByWithoutBiometric:
                                    dr["Evento"] = "Acesso negado por falta de biometria";
                                    break;
                                case TipoPointCV9814EventRecordType.AccessDeniedByForNotBiometricRecognition:
                                    dr["Evento"] = "Acesso negado por não reconhecimento biométrico";
                                    break;
                                case TipoPointCV9814EventRecordType.AccessDeniedByReleaseLista:
                                    dr["Evento"] = "Acesso negado por lista de liberação";
                                    break;
                                default:
                                    break;
                            }
                        ...
                        eventRecords = this._watchComm.ConfirmationReceiptTimePointCV9814EventRecords();
        ...
        #region " ---------------------> Event Handles da Tab Feriados <---------------------"
        
        private void btnLimparGridFeriados_Click(object sender, EventArgs e)
        {
            _dtFeriados = new dsSDKREP.dtFeriadosDataTable();

            this.dtgFeriados.DataSource = _dtFeriados;
        }

        private void btnEnviarFeriados_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                foreach (DataRow dr in this._dtFeriados)
                {
                    feriados.Add(DateTime.Parse(dr["DataFeriado"].ToString()));
                }

                this._watchComm.OpenConnection();

                // Solicita ao componente o envio da lista de feriados.
                try
                {
                    AddHistoricoComando(ETipoOrigemComando.Software,
                                        ETipoComando.InsereFeriadosLista,
                                        ETipoHistorico.Envio,
                                        "Envio da lista de feriados");

                    this._watchComm.IncludeHolidaysList(feriados.ToArray());
        ...
        #region " ---------------------> Event Handles da Tab Permissoes <---------------------"

        private void btnExcluirPermissoes_Click(object sender, EventArgs e)
        {
            InstanciaWatchComm();
            ...
            try
            {
                ...
                // Solicita ao componente a exclusão da permissão.
                try
                {
                    AddHistoricoComando(ETipoOrigemComando.Software,
                                        ETipoComando.RemovePermissaoLista,
                                        ETipoHistorico.Envio,
                                        "Exclusão de permissão");

                    this._watchComm.RemovePermission(Int16.Parse(txtCodigoPermissao.Text));
        ...
        private void btnEnviarPermissoes_Click(object sender, EventArgs e)
        {
            List<TimeSlot> faixasPermissao = new List<TimeSlot>();

            InstanciaWatchComm();

            try
            {
                // Carrega as faixas de permissão.
                foreach (DataRow dr in this._dtFaixasPermissao)
                {
                    faixasPermissao.Add(new TimeSlot() { InitialTime = DateTime.Parse(dr["HorarioInicial"].ToString()) ,
                                                         FinalTime = DateTime.Parse(dr["HorarioFinal"].ToString()) } );
                }

                this._watchComm.OpenConnection();

                // Solicita ao componente o envio da permissão.
                try
                {
                    AddHistoricoComando(ETipoOrigemComando.Software,
                                        ETipoComando.InserePermissaoLista,
                                        ETipoHistorico.Envio,
                                        "Envio de permissão");

                    this._watchComm.IncludePermission(Int16.Parse(txtCodigoPermissao.Text), faixasPermissao.ToArray());
        ...
        private void btnExcluirTodasPermissoes_Click(object sender, EventArgs e)
        {
            InstanciaWatchComm();
            ...
            try
            {
                ...
                // Solicita ao componente a exclusão de todas as permissões.
                try
                {
                    AddHistoricoComando(ETipoOrigemComando.Software,
                                        ETipoComando.ExclusaoTotalPermissoes,
                                        ETipoHistorico.Envio,
                                        "Exclusão completa de permissões");

                    this._watchComm.CleansPermissionList();
