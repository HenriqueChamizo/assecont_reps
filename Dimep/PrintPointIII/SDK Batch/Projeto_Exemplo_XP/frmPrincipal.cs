...
namespace ExemploXP
{
    public partial class frmPrincipal : Form
    {
        ...
        private void InstanciaWatchComm()
        {
            ...
            this._watchComm = new org.cesar.dmplight.watchComm.impl.WatchComm(org.cesar.dmplight.watchComm.api.WatchProtocolType.MicroPoint,
                                                                              tcpComm,
        ...
        private void btnObterRegistrosRelogio_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                while (marcacao != null)
                {
                    AbstractPunchMessage marcacaoMicro = (AbstractPunchMessage)marcacao;
                    ...
                    {
                        Console.WriteLine("Registro Inválido: " + marcacaoMicro.ToString());
                    }                    
        ...
        private void btnEnviarConfiguracoesGerais_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (mskTempoAcionamento.Enabled)
                    ...
                    this._watchComm.ProgramTriggerType(ConverteAcionamento(), 0);
                ...
                // Terminal ativado.
                if (cboAcionamento.SelectedIndex != 0) // Diferente de "Nenhum".
                    this._watchComm.Activation(chkTerminalAtivado.Checked, chkAcessoControlado.Checked);
                else
                    this._watchComm.Activation(chkTerminalAtivado.Checked, false);
