...
namespace PrintPointIII
{
    public class Bridge : AssepontoRep.Bridge
    {
        ...
        public override string getRepFabricante() { return "Dimep - PrintPointIII"; }
        ...
        #region Insere Funcionario Master
        ...
        #region Envia Funcionario Master
